...
const samples = [
  ...
  // Near-duplicate open tickets — a real-world outage where several people
  // report the same thing. These cluster together for one-shot resolution.
  ['VPN down, cannot connect', 'My VPN will not connect at all this morning, completely blocked from the network. Urgent.', 'IT', 'urgent', 'Open', 'Daniel Kim', 0, ''],
  ['VPN not connecting', 'VPN is down for me too, cannot connect to the network and it is blocking my work. Urgent.', 'IT', 'urgent', 'Open', 'Marco Bianchi', 0, ''],
  ['Cannot connect to VPN', 'The VPN keeps failing to connect this morning, network is completely blocked. Very urgent.', 'IT', 'urgent', 'Open', 'Tom Reyes', 0, ''],
  ['Wifi not working in conference room', 'Wifi is very slow and keeps dropping in the meeting rooms on floor 2.', 'IT', 'mild', 'Open', 'Lena Fischer', 0, ''],
];
