// Seeds data.json with a spread of tickets across departments, priorities,
// statuses, and the last few months — gives the analytics and the AI
// "similar tickets" feature something to work with on first run.
...
resetWith(seed);
console.log(`Seeded ${seed.tickets.length} tickets into data.json`);
